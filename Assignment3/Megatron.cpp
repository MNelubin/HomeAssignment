...
Megatron::Megatron(Fraction good = Transformers::Fraction::DECEPTICON,std::string clicku = "NULL",std::string job="NULL",
...
uint Megatron::get_num_grenades() const
{
...
bool Megatron::get_is_knife_on() const
{
